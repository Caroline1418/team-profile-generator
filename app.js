...
const validate = {
    ...
    name: input => input !== ''? true: "Please enter your name",
...
const questions = {
    type: function(){
        return{
            message: "White type of team member would you like to add?",
            type: "list",
            name: "member",
...
async function generateHTML(){
    let Template= {
        Main: await getHTMLModule(""),
        Manager: await getHTMLModule(""),
        Engineer: await getHTMLModule(""),
        Intern: await getHTMLModule("")
    }
